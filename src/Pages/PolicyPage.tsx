const PolicyPage = () => (
  <section className="min-h-[70vh] flex flex-col items-center justify-center py-20 px-6 bg-hero-gradient relative overflow-hidden">
    <div className="absolute -bottom-24 -left-24 w-[400px] h-[400px] rounded-full bg-purple-100 opacity-30 blur-3xl pointer-events-none" />
    <div className="relative text-center max-w-[480px]">
      ...
      <p className="text-brand text-[12px] font-bold tracking-[2px] uppercase mb-3">Policy Information</p>
      <h1 className="text-[36px] font-extrabold text-gray-900 tracking-tight leading-[1.1] mb-4">
        Your Policy Details
      </h1>
      <p className="text-[15px] text-gray-500 leading-relaxed mb-8">
        The self-service policy portal is coming soon. Chat with an agent now to get your full coverage information — including limits, deductibles, and renewal dates.
      </p>
      <button
